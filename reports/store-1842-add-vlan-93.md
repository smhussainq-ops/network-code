...
Generated: 2026-07-03T23:18:18.602260+00:00
...
metadata:
  requested_by: phase0-e2e
  ticket_id: null
  learning_mode: true
vlan:
  id: 93
  name: PHASE0_RUNNER
  subnet: 10.42.93.0/24
  purpose: guest
  svi:
    enabled: false
    gateway_ip: null
...
```bash
git checkout -b change/store-1842-add-vlan-93
git add intents/store-1842/store-1842-add-vlan-93.yaml
git commit -m "Add network intent store-1842-add-vlan-93"
```
